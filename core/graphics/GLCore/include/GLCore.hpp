...
namespace GLCore {
    ...
    GL_CORE_LIB_API void AddBatch(const GeoCore::Quad& quad, const VertexBufferLayout& layout, const std::string& shaderFilePath, const std::string& textureFilePath);
